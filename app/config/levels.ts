...
export const LEVELS = {
    ...
    l1: {
        ...
        buttons: [CONF.ST_ROAD, CONF.ST_STONE_VIOLET, CONF.ST_STONE_RED, CONF.ST_STONE_INDIGO, CONF.ST_STONE_ORANGE, BUTTON_DELETE, BUTTON_DISK],
    ...
    l4: {
        ...
        buttons: [CONF.ST_ROAD_AWAKE, CONF.ST_ROAD_SLEEP, CONF.ST_ROAD, CONF.ST_STONE_VIOLET, CONF.ST_STONE_RED, CONF.ST_STONE_INDIGO, CONF.ST_STONE_ORANGE, BUTTON_DELETE, BUTTON_DISK],
